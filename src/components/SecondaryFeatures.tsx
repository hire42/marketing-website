...
const features = [
  ...
  },
  {
    name: 'Security bond',
    description:
      'Lenders can require a refundable security deposit on their listing. It\'s collected at checkout, and automatically returned to the renter the day after the rental ends — unless the lender makes a claim.',
...
function DeviceShieldIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
      ...
      />
      <path
        d="M16 10l5 2v4c0 2.761-2.239 5-5 5s-5-2.239-5-5v-4l5-2z"
        stroke="#171717"
        strokeWidth={1.5}
