...
function PlaceholderFrame(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 366 729" aria-hidden="true" {...props}>
      ...
      />
      <rect x="154" y="29" width="56" height="5" rx="2.5" fill="#2A2A2C" />
    </svg>
  )
}
...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-[366/729]', className)} {...props}>
      ...
      <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(42/318*100%)]">
        {children}
      </div>
